...
const MAT4_0 = gl_matrix_1.mat4.create(), QUAT_0 = gl_matrix_1.quat.create(), VEC3_0 = gl_matrix_1.vec3.create(), VEC3_UP = gl_matrix_1.vec3.fromValues(0.0, 0.0, 1.0);
class Transform3D extends TransformComponent_1.TransformComponent {
    ...
    lookAt(position) {
        let inverseMatrix = gl_matrix_1.mat4.invert(MAT4_0, this.getMatrix());
        if (inverseMatrix == null) {
            inverseMatrix = gl_matrix_1.mat4.identity(MAT4_0);
        }
        const localPosition = gl_matrix_1.vec3.transformMat4(VEC3_0, position, inverseMatrix);
